package hibernate;
// Generated 2017-12-5 15:49:18 by Hibernate Tools 3.5.0.Final
...
public class AdminHome {
	...
	public Admin merge(Admin detachedInstance) {
		...
		try {
			Admin result = (Admin) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Admin findById(java.io.Serializable id) {
		...
		try {
			Admin instance = (Admin) sessionFactory.getCurrentSession().get("hibernate.Admin", id);
			if (instance == null) {
	...
	public List findByExample(Admin instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("hibernate.Admin")
