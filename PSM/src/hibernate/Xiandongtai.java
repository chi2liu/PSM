...
public class Xiandongtai implements java.io.Serializable {
	...
	private Date intimereal;
	private Date lvetimeplan;
	private Date lvetimereal;
	...
	public Xiandongtai(String repoter, String peixun, String gangwei, String name, String sfz, String sex,
			Date intimeplan, Date intimereal, Date lvetimeplan, Date lvetimereal, String phone, String istijian,
	...
	public Date getIntimereal() {
		return this.intimereal;
	}

	public void setIntimereal(Date intimereal) {
		this.intimereal = intimereal;
	}
	...
	public Date getLvetimereal() {
		return this.lvetimereal;
	}

	public void setLvetimereal(Date lvetimereal) {
		this.lvetimereal = lvetimereal;
	}
