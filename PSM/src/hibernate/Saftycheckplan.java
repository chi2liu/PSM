...
/**
 * Saftycheckplan generated by hbm2java
 */
public class Saftycheckplan implements java.io.Serializable {
	...
	public Saftycheckplan() {
	}

	public Saftycheckplan(String bzren, Date bztime, String spren, Date sptime, String accessory, String projectName) {
		this.bzren = bzren;
		this.bztime = bztime;
		this.spren = spren;
		this.sptime = sptime;
