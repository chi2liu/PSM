...
class SmsSenderUtil {
    ...
    //============统计      （自己另加的）========================
    public SmsStatusSendPullerResult jsonToSmsStatusSendPullerResult(JSONObject json) {
    	SmsStatusSendPullerResult result = new SmsStatusSendPullerResult();
    	...
    	result.data.request=json.getInt("request");
    	result.data.success=json.getInt("success");
    	result.data.bill_number=json.getInt("bill_number");
    	return result;
    }
    //======================================
