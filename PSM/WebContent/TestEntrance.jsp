		...
		<div class="form-container">
			<div class="signin">
				<form name="TestLogin" id="TestLogin" onsubmit="return testlogin_submit();" action="EduTrainAction!testLogin" method="post" autocomplete="off">
					...
					<select name="testID" class="role"></select>
					<input type="text" name="name" class="username" placeholder="姓　名">
					<input type="text" name="idno" class="username" placeholder="身份证">				
...
<!--  
<form name="TestLogin" id="TestLogin" onsubmit="return true;" action="EduTrainAction!testLogin" method="post">
	<table>
		<tr>
			<td>考　试：</td>
			<td>
