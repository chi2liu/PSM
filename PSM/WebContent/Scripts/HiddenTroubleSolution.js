...
//end--------------------------------------------------------------------------------------------------------------------
        ...
        {	
        	...
        	column = [
            	    ...
            	    { text: '作业', dataIndex: 'JobActivity', align: 'center', width: 150},
            	    { text: '危险（源）有害因素', dataIndex: 'BadFactor', align: 'center', width: 200},
            	    { text: '可能导致的伤害∕事故', dataIndex: 'BadEvent', align: 'center', width: 150},
            	    { text: '风险', dataIndex: 'Rank', align: 'center', width: 150},
            	    { text: '控 制 措 施', dataIndex: 'ControlAction', align: 'center', width: 150},
                		...
                		if(title == '危险源动态管控')
                		{
                			var record = dataStore.getAt(rowIndex);
             		         ...
             		         html_str = "<h1 style=\"padding: 5px;\"><center>"+
             		                    ...
             		                    "</td><td width=\"15%\" style=\"padding:5px;\">作业</td><td width=\"40%\">" + record.get("JobActivity") + 
             		                    "</td></tr><tr><td style=\"padding:5px;\">危险（源）有害因素</td><td>" + record.get('BadFactor') + 
                                        "</td><td style=\"padding:5px;\">可能导致的伤害∕事故</td><td>" + record.get('BadEvent') + 
                                        "</tr><tr></td><td style=\"padding:5px;\">风险</td><td>" + record.get('Rank') + 
                                        "</td><td style=\"padding:5px;\"> 控 制 措 施</td><td>" +  record.get('ControlAction')+ "</td></tr>"+
                                        "</tr><tr></td><td style=\"padding:5px;\">签批意见</td><td  align=\"left\"  colspan=\"3\">" + record.get('Yijian') +  "</td></tr>";
