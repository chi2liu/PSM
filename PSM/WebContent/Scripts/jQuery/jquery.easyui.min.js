...
//////---------sxw-0831------
var tmp1_ = _6a.pageSize*(_6a.pageNumber-1);
tmp1_ = (_6a.total == 0) ? 0 : (tmp1_ + 1);
_6c = _6c.replace(/{from}/, tmp1_);
////----------------------------
...
$.fn.pagination.defaults={total:0,pageSize:10,pageNumber:1,pageList:[10,20,30,50],loading:false,buttons:null,showPageList:true,showRefresh:false,onSelectPage:function(_75,_76){
...
$.fn.calendar.defaults={width:180,height:180,fit:false,border:true,weeks:["日","一","二","三","四","五","六"],months:["一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月"],year:new Date().getFullYear(),month:new Date().getMonth()+1,current:new Date(),onSelect:function(date){
}};
})(jQuery);
(function($){
function init(_349){
