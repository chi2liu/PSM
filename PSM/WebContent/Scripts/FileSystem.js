...
//							});
        	...
        	showWin({ 
        		...
        		buttons: [{        	
	            	...
	            	handler: function(){
	            		...
	            		var win = this;
	            		$.getJSON('FileSystemAction!importExcel', { fileName: fileName, type : title },
	            				function(data) {
        ...
        if (tableID >= 69 && tableID <= 73) {	
        	...
        	dataStore.load();
        	queryURL = 'FileSystemAction!getCommonfileListSearch?userName=' + user.name + "&userRole=" + user.role + "&type=" + title;
        	column = [
        		{ text: '序号', xtype: 'rownumberer',width: 40,sortable: false},	
