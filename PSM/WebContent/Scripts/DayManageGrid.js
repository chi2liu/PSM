                		...
                		if(title == '安全工作日志')
                		{
                			var record = dataStore.getAt(rowIndex);
            		         ...
            		         html_str = "<h1 style=\"padding: 5px;\"><center>"+
            		                    ...
            		                    "<table width=\"98%\" border=\"2\" style=\"table-layout:fixed;margin:auto;border-collapse:collapse;text-align:center;\">"+
            		                    "<tr><td width=\"15%\" style=\"padding:5px;\">序号</td ><td>" + Num + 
            		                    "</td><td width=\"15%\" style=\"padding:5px;\">日期</td><td width=\"40%\">" + record.get("rizhitime") + 
            		                    "</td></tr><tr><td style=\"padding:5px;\">星期</td><td>" + record.get('weekday') + 
                                       "</td><td style=\"padding:5px;\">气象白天</td><td>" + record.get('qixiday')   + 
                                       "</td></tr><tr><td style=\"padding:5px;\">气象夜间</td><td>" + record.get('qixinight') + 
                                       "</td><td style=\"padding:5px;\">气温最高(℃)</td><td>" + record.get('degreeday')   + 
                                       "</td></tr><tr><td style=\"padding:5px;\">气温最低(℃)</td><td>" + record.get('degreenight') + 
                                       "</td><td style=\"padding:5px;\">风力白天</td><td>" + record.get('windday')   + 
                                       "</tr><tr></td><td style=\"padding:5px;\">风力夜间</td><td  align=\"left\"  colspan=\"3\">" + record.get('windnight')+  "</td></tr>"+
   		                               "</tr><tr></td><td style=\"padding:5px;\">日志记录</td><td  align=\"left\"  colspan=\"3\">" + record.get('rizhi')+  "</td></tr>"+
            		                  "</tr><tr></td><td style=\"padding:5px;\">工作计划/重点</td><td  align=\"left\"  colspan=\"3\">" + record.get('workplan')+  "</td></tr>";
            		        html_str+="<tr><td style=\"padding:5px;\">附件</td><td colspan=\"3\">";
