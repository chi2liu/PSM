...
//                                        ShownodeMessageOnEastpanel(checklabel);
		...
		var flow_store = Ext.create('Ext.data.Store', {
            ...
            proxy: {
                type: 'ajax',
                url:encodeURI('GoalDutyAction!getFlowNodeList?tableid='+tableID+'&projectName='+projectName),
                reader: {
                    type: 'json'
                }
            },
		...
		var ShownodeMessageOnEastpanel = function (clicknode) {
	        ...
	        var grid = Ext.create('Ext.grid.Panel', {
	            ...
	            store: {
	                ...
	                proxy: {
	                    type: 'ajax',
	                    url:encodeURI('GoalDutyAction!getFileNameList?clicknode='+clicknode+'&tableid='+tableID+'&stepNum='+nowStepNum+'&projectName='+projectName),
