                		...
                		if(title == '上级检查问题整改及回复')
                		{
                			var record = dataStore.getAt(rowIndex);
             		         ...
             		         html_str = "<h1 style=\"padding: 5px;\"><center>"+
             		                    ...
             		                    "<tr><td width=\"15%\" style=\"padding:5px;\">检查时间</td ><td>" + record.get("checktime") + 
             		                    "</td><td width=\"15%\" style=\"padding:5px;\">检查类型</td><td width=\"40%\">" + record.get("checktype") + 
             		                    "</td></tr><tr><td style=\"padding:5px;\">检查单位</td><td>" + record.get('checkunit') + 
                                        "</td><td style=\"padding:5px;\">受检单位</td><td>" + record.get('shoujianunit') + 
                                        "</tr><tr></td><td style=\"padding:5px;\">检查人员</td><td>" + record.get('checkperson') + 
                                        "</td><td style=\"padding:5px;\"> 安全检查记录表/整改通知单编号</td><td>" +  record.get('noticeandnum')+
                                        "</tr><tr></td><td style=\"padding:5px;\">整改回复单编号</td><td>" + record.get('replyandnum') + 
                                        "</td><td style=\"padding:5px;\"> 整改回复时间</td><td>" +  record.get('replytime')+
                                        "</tr><tr></td><td style=\"padding:5px;\">整改时限</td><td  align=\"left\"  colspan=\"3\">" + record.get('timeline') +  "</td></tr>"+
                                        "</tr><tr></td><td style=\"padding:5px;\">整改问题</td><td  align=\"left\"  colspan=\"3\">" + strEdit(record.get('problem'),gridDT) +  "</td></tr>"+
             		                    "</tr><tr></td><td style=\"padding:5px;\">建议</td><td  align=\"left\"  colspan=\"3\">" + strEditadv(record.get('advice'),gridDT) +  "</td></tr>";
                		...
                		if(title == '日常安全检查'||title == '定期安全检查'||title == '季节性安全检查'||title == '复工检查'||title == '专项安全检查'||title=='安全生产目标检查与纠偏'||title=='分包方目标管理')
                		{
                			var record = dataStore.getAt(rowIndex);
             		         ...
             		         html_str = "<h1 style=\"padding: 5px;\"><center>"+
             		                    ...
             		                    "<tr><td width=\"15%\" style=\"padding:5px;\">检查时间</td ><td>" + record.get("checktime") + 
             		                    "</td><td width=\"15%\" style=\"padding:5px;\">检查类型</td><td width=\"40%\">" + record.get("checktype") + 
             		                    "</td></tr><tr><td style=\"padding:5px;\">检查内容</td><td>" + record.get('content') + 
                                        "</td><td style=\"padding:5px;\">受检单位</td><td>" + record.get('shoujianunit') + 
                                        "</tr><tr></td><td style=\"padding:5px;\">检查人员</td><td>" + record.get('checkperson') + 
                                        "</td><td style=\"padding:5px;\"> 安全检查记录表/整改通知单编号</td><td>" +  record.get('noticeandnum')+
                                        "</tr><tr></td><td style=\"padding:5px;\">整改回复单编号</td><td>" + record.get('replyandnum') + 
                                        "</td><td style=\"padding:5px;\"> 整改回复时间</td><td>" +  record.get('replytime')+
                                        "</tr><tr></td><td style=\"padding:5px;\">整改时限</td><td>" + record.get('timeline') + 
                                        "</td><td style=\"padding:5px;\"> 整改复查情况</td><td>" +  record.get('replyandnum')+
                                        "</tr><tr></td><td style=\"padding:5px;\">整改问题</td><td  align=\"left\"  colspan=\"3\">" + strEdit(record.get('problem'),gridDT) +  "</td></tr>";
             		        html_str+="<tr><td style=\"padding:5px;\">附件</td><td colspan=\"3\">";
